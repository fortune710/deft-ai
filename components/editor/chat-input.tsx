...
import { Plus, ChevronUp, Mic, ArrowRight, MessageSquare, Edit3 } from 'lucide-react';
            ...
            <div className="pointer-events-auto rounded-2xl bg-[#2A2A2A]/40 dark:bg-[#1E1E1E] border border-border/50 shadow-sm transition-shadow flex flex-col p-1.5 backdrop-blur-md">
                ...
                <div className="flex items-center justify-between px-1.5 pb-1">
                    <div className="flex items-center gap-1">
                        <Button variant="ghost" size="icon" className="h-6 w-6 rounded-md hover:bg-white/10 text-muted-foreground">
                        ...
                        <Popover>
                            ...
                            <PopoverContent side="top" align="start" className="w-48 p-1 z-[100]">
                                <div className="flex flex-col gap-1">
                                    ...
                                    >
                                        <MessageSquare className="h-4 w-4 mr-2" /> Ask
                                    </Button>
                                    <Button
                                        variant="ghost"
                                        size="sm"
                                    ...
                                    >
                                        <Edit3 className="h-4 w-4 mr-2" /> Edit Output
                                    </Button>
                                </div>
                            </PopoverContent>
                        </Popover>
